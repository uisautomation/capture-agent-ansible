...
mkisofs -r -V "Capture Agent Install" -cache-inodes -J -l -b isolinux/isolinux.bin -c isolinux/boot.cat -no-emul-boot -boot-load-size 4 -boot-info-table -o ./iso/lc.iso /tmp/working-iso/
isohybrid iso/lc.iso
